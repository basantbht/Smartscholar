...
const Events = () => {
  ...
  // Fetch all colleges events on component mount
  useEffect(() => {
  ...
  const EventCard = ({ event }) => {
    ...
    return (
      <div className="group bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 transition-all duration-200 cursor-pointer overflow-hidden shadow-sm hover:shadow-lg">
        {/* Event Image */}
                  ...
                  {eventTypes.map((type) => (
                    ...
                    >
                      ...
                      <span className="ml-auto text-xs text-gray-400">
                        {
                          allEvents.filter((event) => event.eventType === type)
                            .length
                        }
                      </span>
                    </label>
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-2 cursor-pointer group">
                    ...
                    <span className="ml-auto text-xs text-gray-400">
                      {
                        allEvents.filter((e) =>
                          isFuture(new Date(e.registrationDeadline))
                        ).length
                      }
                    </span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer group">
                    ...
                    <span className="ml-auto text-xs text-gray-400">
                      {
                        allEvents.filter((e) =>
                          isPast(new Date(e.registrationDeadline))
                        ).length
                      }
                    </span>
                  </label>
